...
# ----------------------------------------------------------------------------------------------------------------------
        ...
        self.__server_pass = 'root_password'
...
# ----------------------------------------------------------------------------------------------------------------------
    ...
    def __format(self, locally=None):
        # if locally = "locally" then formatting will assume that the client and servers are running on a single machine.
        if locally is None:
            locally = "none"
        # locally = "locally"
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute(sql, ())
            print(" 'file_map' table has been created....")
            ...
            cursor.execute(sql, ())
            print(" 'dir_map' table has been created....")
            ...
            for machine_id in self.__machine_dict.keys():
                ...
                print("Data successfully inserted into 'file_map' table..... ")
        connection.commit()
